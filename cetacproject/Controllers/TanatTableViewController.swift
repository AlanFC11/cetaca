...
class TanatTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        servicioControlador.fetchTanats{ (result) in
            switch result{
    ...
    func createAlertTanat (title:String, message: String, index: Int){
        let alert = UIAlertController(title: title, message: message, preferredStyle: UIAlertController.Style.alert)
        alert.addAction(UIAlertAction(title: "OK", style: UIAlertAction.Style.default, handler: {(action) in alert.dismiss(animated: true, completion: nil)}))
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        self.createAlertTanat(title: "Tanatólogo", message: "Nombre:" + datos[rowNumber].nombre + "\n Email:" + datos[rowNumber].mail + "\n ID:" + datos[rowNumber].id, index: rowNumber)
